  ...
  return (
    <div className="flex flex-col gap-3 mb-2">
      <div className="flex gap-3">
        <button
          type="button"
          className="flex-1 flex items-center justify-center gap-2.5 h-12 rounded-xl border-2 border-zinc-200 bg-white hover:border-[#ffc107] hover:bg-[#fffdf0] transition-all duration-200 font-semibold text-[14px] text-[#121212]"
        >
          <GoogleIcon />
          Google
        </button>
