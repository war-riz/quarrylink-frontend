...
import { MOCK_ORDERS } from "@/constants/dashboardConstants";
...
const totalSpent = MOCK_ORDERS.reduce((sum, o) =>
  o.status === "completed" ? sum + o.total : sum, 0);

const escrowHeld = MOCK_ORDERS.reduce((sum, o) =>
  !["completed", "cancelled"].includes(o.status) ? sum + o.total : sum, 0);

export function PaymentsTab() {
  const transactions = [...MOCK_ORDERS]
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          },
          {
            ...
            value: "4",
            sub: formatNaira(MOCK_ORDERS.reduce((s, o) => s + o.total, 0)) + " total",
            icon: CreditCard,
            color: "#3b82f6",
            bg: "#dbeafe",
          },
      ...
      <div className="bg-[#121212] rounded-2xl p-5 flex items-start gap-4 relative overflow-hidden">
        ...
        <div className="z-10">
          <p className="font-bold text-[14px] text-white mb-1">
            How QuarryLink Escrow Works
          </p>
          <p className="text-[12px] text-white/50 leading-relaxed">
            Your payment is held securely when you place an order. Funds are only
            released to the supplier and driver after you confirm delivery. You're
            always protected.
          </p>
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="text-right shrink-0">
                  <p className="font-extrabold text-[14px] text-[#121212]">
